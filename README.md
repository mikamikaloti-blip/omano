...
**۲. کلیدی که من برات فرستادم رو فعال کن:**
```bash
...
> ⏱ لایسنس‌ها **محدود به زمان** هستن (مثلاً ۴۸ ساعت). بعد از انقضا باید از من کلید جدید بگیری. تاریخ دقیق انقضا رو `lic status` نشون میده.
